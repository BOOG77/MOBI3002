/*
Student Name: Dawson Brown
Student Number w0468898
Due Date: November 9, 2025
Course: Mobi3002 Mobile Application Development
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                EditText textN1 = findViewById(R.id.input1);
                EditText textN2 = findViewById(R.id.input2);
                // we actually don't need to get ans from screen
                EditText textANS = findViewById(R.id.answer);

                try {
                    firstNumber = Double.parseDouble(textN1.getText().toString());
                    secondNumber = Double.parseDouble(textN2.getText().toString());
                ...
                Log.w("M01_Calculator ADD BUTTON", "Add Selected with => " + firstNumber + " + " + secondNumber + "=" + answer);
            }
        });
