...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tempvalueText = findViewById(R.id.temperatureValue);
        bouncingBallView.setTemperatureDisplay(tempvalueText);
    ...
    protected void onDestroy() {
        super.onDestroy();
        ExoPlayer player = bouncingBallView.getPlayer();
        player.release();
    }
